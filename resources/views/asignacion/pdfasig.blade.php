    ...
    <body>
        <header>        <!-- Cabecera -->
            ...
            <table class="rotulo" width="100%" border="0" cellpadding="0" cellspacing="0">   <!-- tabla encabezado  -->
                <tr>
                    <th width="100%">
                        <h2 align="center" >COMPROMISO DE BUEN USO Y CONFIDENCIALIDAD</h2>
                    </th>
                </tr>
            </table>
        ...
        <main>
            ...
            <br>
            <div style="font-family: Poppins font-size: 10px">
                En cumplimiento de lo expresado firman en conformidad.
            </div>
            <br>
            <br>
            <br>
            ...
            <div style="font-family: Poppins font-size: 10px" align="center">
                Responsable de la Unidad Solicitante <br>
                <br>
                <br>
                {{ $fir}} <br>
                <br>
                <br>
                Jefe del Departamento de Redes Sociales
            </div>
